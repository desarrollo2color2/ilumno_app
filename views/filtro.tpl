...
<?php 
	...
	if(isset($params['ordernar_por']) && isset($params['ordernar_campo'])) :
		
		

		$ordenar_campo = $params['ordernar_campo'];
		$ordenar_por   = $params['ordernar_por'];

		unset($params['ordernar_por']);
		unset($params['ordernar_campo']);
...
<h3>(<?php echo count($params); ?>) Resultados <small>de <?php echo $total; ?> registros en total</small></h3>
			...
			<div class="form-group">
				<label>
					<select name="por" class="form-control" required>
						...
						<option <?php echo($ordenar_por == 'ASC') ? 'selected' : ''; ?> value="ASC">Descendente</option>
						<option <?php echo($ordenar_por == 'DSC') ? 'selected' : ''; ?> value="DSC">Ascendente</option>
					</select>
				</label>
			...
			<div class="form-group">
				<label>
					<select name="campo" class="form-control" required>
						...
						<option <?php echo($ordenar_campo == 'nombre') ? 'selected' : ''; ?> value="nombre">Nombre</option>
						<option <?php echo($ordenar_campo == 'cobertura:num_sedes') ? 'selected' : ''; ?> value="cobertura:num_sedes">Numero de sedes</option>
						<option <?php echo($ordenar_campo == 'poblacion:total') ? 'selected' : ''; ?> value="poblacion:total">Poblacion total</option>
						<option <?php echo($ordenar_campo == 'personal:docentes') ? 'selected' : ''; ?> value="personal:docentes">Personal docentes</option>
						<option <?php echo($ordenar_campo == 'personal:adtivos') ? 'selected' : ''; ?> value="personal:adtivos">Personal adtivos</option>
						<option <?php echo($ordenar_campo == 'ingresos:total_ingresos') ? 'selected' : ''; ?> value="ingresos:total_ingresos">Total ingresos</option>

						<option <?php echo($ordenar_campo == 'modalidad:presencial') ? 'selected' : ''; ?> value="modalidad:presencial">Presencial</option>
						<option <?php echo($ordenar_campo == 'modalidad:distancia') ? 'selected' : ''; ?> value="modalidad:distancia">Distancia</option>
						<option <?php echo($ordenar_campo == 'modalidad:virtual') ? 'selected' : ''; ?> value="modalidad:virtual">Virtual</option>
						<option <?php echo($ordenar_campo == 'tier') ? 'selected' : ''; ?> value="tier">Tier</option>
						<option <?php echo($ordenar_campo == 'rank_nacional') ? 'selected' : ''; ?> value="rank_nacional">Ranking nacional</option>
						<option <?php echo($ordenar_campo == 'rank_lati') ? 'selected' : ''; ?> value="rank_lati">Ranking latinoamerica</option>
						<option <?php echo($ordenar_campo == 'rank_mundial') ? 'selected' : ''; ?> value="rank_mundial">Ranking mundial</option>
