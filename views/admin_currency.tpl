...
<h1 class="title"><i class="fa fa-user"></i>Moneda</h1>

<form action="<?php  if(isset($params['action'])) :  echo $params['action']; unset($params['action']); else : echo URL.'admin/insert_currency'; endif; ?>" method="POST">
	...
	<div class="form-group">
		...
		<input class="form-control" value="<?php echo isset($params['nombre']) ? $params['nombre'] : ''; ?>" type="text" placeholder="Nombre moneda" name="nombre" required />
