					...
					<label style="width:170px;">
						<select class="form-control" style="width:170px;" id="pais" name="id_pais" required>
							...
							<?php foreach($params['paises'] as $pais) : ?>
								...
								<option style="text-transform:uppercase;" <?php echo $selected; ?>  value="<?php echo $pais['id']; ?>"><?php echo strtoupper($pais['nombre']); ?></option>
							<?php endforeach; ?>
						</select>
					</label>
	...
	<script type="text/javascript">
	   ...
	   $('input[type="checkbox"]').change(function(e){
		...
		$('#pais').change(function(e){
			...
			$('.cobertura_btn').text('Selecciona las ciudades de cobertura');
